...
- [x] `std.rag` foundation: typed Corvid document/chunk/embedder envelopes plus runtime document construction, markdown loading, deterministic chunking, per-chunk provenance keys, and OpenAI/Ollama embedder configuration metadata.
