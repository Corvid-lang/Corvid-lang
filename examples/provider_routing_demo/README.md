...
tests, eval assertions, and all provider replay fixtures together. If a provider
route changes model names, keep `corvid.toml`, source `model` declarations, and
trace model fields aligned.
