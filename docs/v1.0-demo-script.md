...
> **Punchline.** When four independent execution paths agree on the algebra of a program and disagree only on the programs they're *meant* to disagree on, the algebra is real. See [docs/effects-spec/12-verification.md](./effects-spec/12-verification.md) for the full methodology.
...
| "Is this actually fast?" | Show `docs/memory-foundation-results.md`; be honest about the 25-36× Python / 1.7-2.6× TypeScript orchestration numbers from Phase 17 and explain that v1.0 is correctness-first, performance parity post-v1.0 |
| "Show me the counterexamples corpus" | `ls docs/effects-spec/counterexamples/` + `cat docs/effects-spec/counterexamples/composition/and_with_or.cor` |
...
2. Work through `docs/effects-spec/00-overview.md`
...
4. Read [docs/effects-spec/14-replay.md](./effects-spec/14-replay.md) if the Phase 21 claims caught their attention.
5. Read [docs/effects-spec/11-related-work.md](./effects-spec/11-related-work.md) if they want to compare against Koka, Eff, Frank, or effect handlers in Haskell.
