...
use corvid_connector_runtime::{
    ...
    BearerTokenResolver, ConnectorAuthState, ConnectorManifest, ConnectorRealClient,
...
/// Verify an inbound webhook signature using HMAC-SHA256. The
/// signature header format is provider-specific; this helper
/// accepts the raw expected hex digest after stripping any
/// `sha256=` prefix common to GitHub / Slack / Linear webhooks.
/// Comparison is constant-time to avoid timing-attack leakage of
/// the secret.
