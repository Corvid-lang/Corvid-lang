...
fn cmd_observe_explain(trace_id: String, trace_dir: PathBuf) -> Result<u8> {
...
fn cmd_observe_cost_optimise(agent: String, trace_dir: PathBuf, top_n: usize) -> Result<u8> {
...
fn cmd_eval_drift(baseline: PathBuf, candidate: PathBuf, _explain: bool) -> Result<u8> {
